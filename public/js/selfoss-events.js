        ...
        if ($.inArray(selfoss.events.section,
            ...
            if (selfoss.events.subsection) {
                ...
                if (selfoss.events.subsection.substr(0, 4) == 'tag-') {
                    ...
                    selfoss.ui.showError($('#lang').data('subsection_error') + ': '
                                         + selfoss.events.subsection);
                    done();
                    return;
                }
            ...
            selfoss.activeAjaxReq = $.ajax({
                ...
                error: function(jqXHR, textStatus, errorThrown) {
                    if (textStatus == 'abort') {
                        ...
                        selfoss.ui.showError($('#lang').data('session_expired'));
                        selfoss.logout();
                    } else if (errorThrown) {
            ...
            selfoss.ui.showError($('#lang').data('subsection_error') + ': ' + selfoss.events.section);
        }
        done();
    },
